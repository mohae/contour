...
func TestCanUpdate(t *testing.T) {
	tests := []struct {
		...
		// 30
		{"corebool", EnvVar, true, true, false, false, CoreUpdateErr{k: "corebool"}},
		{"corebool", EnvVar, false, false, true, false, CoreUpdateErr{k: "corebool"}},
		{"corebool", EnvVar, false, true, true, false, CoreUpdateErr{k: "corebool"}},
		...
		// 75
		{"coreint", EnvVar, true, true, false, false, CoreUpdateErr{k: "coreint"}},
		{"coreint", EnvVar, false, false, true, false, CoreUpdateErr{k: "coreint"}},
		{"coreint", EnvVar, false, true, true, false, CoreUpdateErr{k: "coreint"}},
		...
		// 120
		{"coreint64", EnvVar, true, true, false, false, CoreUpdateErr{k: "coreint64"}},
		{"coreint64", EnvVar, false, false, true, false, CoreUpdateErr{k: "coreint64"}},
		{"coreint64", EnvVar, false, true, true, false, CoreUpdateErr{k: "coreint64"}},
		...
		// 165
		{"corestring", EnvVar, true, true, false, false, CoreUpdateErr{k: "corestring"}},
		{"corestring", EnvVar, false, false, true, false, CoreUpdateErr{k: "corestring"}},
		{"corestring", EnvVar, false, true, true, false, CoreUpdateErr{k: "corestring"}},
		...
		{"cfgbool", Basic, false, true, false, false, UpdateErr{typ: "configuration file", k: "cfgbool"}},
		{"cfgbool", Basic, true, true, false, false, UpdateErr{typ: "configuration file", k: "cfgbool"}},
		{"cfgbool", Basic, false, false, true, false, UpdateErr{typ: "configuration file", k: "cfgbool"}},
		// 185
		...
		// 210
		{"cfgbool", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "cfgbool", slug: "is not an env var"}},
		{"cfgbool", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "cfgbool", slug: "is not an env var"}},
		{"cfgbool", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "cfgbool", slug: "is not an env var"}},
		...
		{"cfgint", Basic, false, true, false, false, UpdateErr{typ: "configuration file", k: "cfgint"}},
		{"cfgint", Basic, true, true, false, false, UpdateErr{typ: "configuration file", k: "cfgint"}},
		{"cfgint", Basic, false, false, true, false, UpdateErr{typ: "configuration file", k: "cfgint"}},
		// 230
		...
		// 255
		{"cfgint", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "cfgint", slug: "is not an env var"}},
		{"cfgint", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "cfgint", slug: "is not an env var"}},
		{"cfgint", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "cfgint", slug: "is not an env var"}},
		...
		{"cfgint64", Basic, false, true, false, false, UpdateErr{typ: "configuration file", k: "cfgint64"}},
		{"cfgint64", Basic, true, true, false, false, UpdateErr{typ: "configuration file", k: "cfgint64"}},
		{"cfgint64", Basic, false, false, true, false, UpdateErr{typ: "configuration file", k: "cfgint64"}},
		// 275
		...
		// 300
		{"cfgint64", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "cfgint64", slug: "is not an env var"}},
		{"cfgint64", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "cfgint64", slug: "is not an env var"}},
		{"cfgint64", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "cfgint64", slug: "is not an env var"}},
		...
		{"cfgstring", Basic, false, true, false, false, UpdateErr{typ: "configuration file", k: "cfgstring"}},
		{"cfgstring", Basic, true, true, false, false, UpdateErr{typ: "configuration file", k: "cfgstring"}},
		{"cfgstring", Basic, false, false, true, false, UpdateErr{typ: "configuration file", k: "cfgstring"}},
		// 320
		...
		// 345
		{"cfgstring", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "cfgstring", slug: "is not an env var"}},
		{"cfgstring", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "cfgstring", slug: "is not an env var"}},
		{"cfgstring", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "cfgstring", slug: "is not an env var"}},
		...
		{"envbool", Basic, true, false, false, false, UpdateErr{typ: "env var", k: "envbool"}},
		{"envbool", Basic, false, true, false, false, UpdateErr{typ: "env var", k: "envbool"}},
		{"envbool", Basic, true, true, false, false, UpdateErr{typ: "env var", k: "envbool"}},
		{"envbool", Basic, false, false, true, false, UpdateErr{typ: "env var", k: "envbool"}},
		// 365
		...
		// 390
		{"envbool", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "envbool", slug: "already set from env vars"}},
		{"envbool", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "envbool", slug: "already set from flags"}},
		{"envbool", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "envbool", slug: "already set from flags"}},
		...
		{"envint", Basic, false, true, false, false, UpdateErr{typ: "env var", k: "envint"}},
		{"envint", Basic, true, true, false, false, UpdateErr{typ: "env var", k: "envint"}},
		{"envint", Basic, false, false, true, false, UpdateErr{typ: "env var", k: "envint"}},
		// 410
		...
		// 435
		{"envint", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "envint", slug: "already set from env vars"}},
		{"envint", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "envint", slug: "already set from flags"}},
		{"envint", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "envint", slug: "already set from flags"}},
		...
		{"envint64", Basic, true, false, false, false, UpdateErr{typ: "env var", k: "envint64"}},
		{"envint64", Basic, false, true, false, false, UpdateErr{typ: "env var", k: "envint64"}},
		{"envint64", Basic, true, true, false, false, UpdateErr{typ: "env var", k: "envint64"}},
		// 455
		{"envint64", Basic, false, false, true, false, UpdateErr{typ: "env var", k: "envint64"}},
		...
		// 480
		{"envint64", EnvVar, false, true, false, false, updateErr{typ: EnvVar, k: "envint64", slug: "already set from env vars"}},
		{"envint64", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "envint64", slug: "already set from env vars"}},
		{"envint64", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "envint64", slug: "already set from flags"}},
		{"envint64", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "envint64", slug: "already set from flags"}},
		...
		{"envstring", Basic, true, true, false, false, UpdateErr{typ: "env var", k: "envstring"}},
		// 500
		{"envstring", Basic, false, false, true, false, UpdateErr{typ: "env var", k: "envstring"}},
		...
		// 525
		{"envstring", EnvVar, false, true, false, false, updateErr{typ: EnvVar, k: "envstring", slug: "already set from env vars"}},
		{"envstring", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "envstring", slug: "already set from env vars"}},
		{"envstring", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "envstring", slug: "already set from flags"}},
		{"envstring", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "envstring", slug: "already set from flags"}},
		...
		{"flagbool", Basic, true, true, false, false, UpdateErr{typ: "flag", k: "flagbool"}},
		// 545
		{"flagbool", Basic, false, false, true, false, UpdateErr{typ: "flag", k: "flagbool"}},
		...
		// 570
		{"flagbool", EnvVar, false, true, false, false, updateErr{typ: EnvVar, k: "flagbool", slug: "already set from env vars"}},
		{"flagbool", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "flagbool", slug: "already set from env vars"}},
		{"flagbool", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "flagbool", slug: "already set from flags"}},
		{"flagbool", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "flagbool", slug: "already set from flags"}},
		...
		{"flagint", Basic, true, false, false, false, UpdateErr{typ: "flag", k: "flagint"}},
		{"flagint", Basic, false, true, false, false, UpdateErr{typ: "flag", k: "flagint"}},
		// 590
		{"flagint", Basic, true, true, false, false, UpdateErr{typ: "flag", k: "flagint"}},
		{"flagint", Basic, false, false, true, false, UpdateErr{typ: "flag", k: "flagint"}},
		{"flagint", Basic, false, true, true, false, UpdateErr{typ: "flag", k: "flagint"}},
		...
		{"flagint", EnvVar, false, true, false, false, updateErr{typ: EnvVar, k: "flagint", slug: "already set from env vars"}},
		{"flagint", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "flagint", slug: "already set from env vars"}},
		{"flagint", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "flagint", slug: "already set from flags"}},
		{"flagint", EnvVar, false, true, true, false, updateErr{typ: EnvVar, k: "flagint", slug: "already set from flags"}},
		// 620
		...
		{"flagint64", Basic, true, false, false, false, UpdateErr{typ: "flag", k: "flagint64"}},
		// 635
		{"flagint64", Basic, false, true, false, false, UpdateErr{typ: "flag", k: "flagint64"}},
		{"flagint64", Basic, true, true, false, false, UpdateErr{typ: "flag", k: "flagint64"}},
		{"flagint64", Basic, false, false, true, false, UpdateErr{typ: "flag", k: "flagint64"}},
		{"flagint64", Basic, false, true, true, false, UpdateErr{typ: "flag", k: "flagint64"}},
		...
		{"flagint64", EnvVar, false, true, false, false, updateErr{typ: EnvVar, k: "flagint64", slug: "already set from env vars"}},
		{"flagint64", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "flagint64", slug: "already set from env vars"}},
		{"flagint64", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "flagint64", slug: "already set from flags"}},
		// 665
		...
		// 680
		{"flagstring", Basic, true, false, false, false, UpdateErr{typ: "flag", k: "flagstring"}},
		{"flagstring", Basic, false, true, false, false, UpdateErr{typ: "flag", k: "flagstring"}},
		{"flagstring", Basic, true, true, false, false, UpdateErr{typ: "flag", k: "flagstring"}},
		{"flagstring", Basic, false, false, true, false, UpdateErr{typ: "flag", k: "flagstring"}},
		{"flagstring", Basic, false, true, true, false, UpdateErr{typ: "flag", k: "flagstring"}},
		// 685
		...
		{"flagstring", EnvVar, true, true, false, false, updateErr{typ: EnvVar, k: "flagstring", slug: "already set from env vars"}},
		// 710
		{"flagstring", EnvVar, false, false, true, false, updateErr{typ: EnvVar, k: "flagstring", slug: "already set from flags"}},
		...
		{"bool", EnvVar, true, true, false, false, updateErr{typ: ConfFileVar, k: "bool", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		// 755
		{"bool", EnvVar, false, false, true, false, updateErr{typ: ConfFileVar, k: "bool", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		...
		// 800
		{"int", EnvVar, true, true, false, false, updateErr{typ: ConfFileVar, k: "int", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		{"int", EnvVar, false, false, true, false, updateErr{typ: ConfFileVar, k: "int", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		...
		{"int64", EnvVar, true, true, false, false, updateErr{typ: ConfFileVar, k: "int64", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		// 845
		{"int64", EnvVar, false, false, true, false, updateErr{typ: ConfFileVar, k: "int64", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		...
		{"string", EnvVar, true, true, false, false, updateErr{typ: ConfFileVar, k: "string", slug: fmt.Sprintf("is not an %s", EnvVar)}},
		// 890
		{"string", EnvVar, false, false, true, false, updateErr{typ: ConfFileVar, k: "string", slug: fmt.Sprintf("is not an %s", EnvVar)}},
